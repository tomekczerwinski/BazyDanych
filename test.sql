...
/*
--CHCĄC USUNĄĆ I STWORZYĆ BAZĘ DANYCH TRZEBA MIEĆ UPRAWNIENIA
--Usuwamy bazę danych
USE tempdb;
GO
IF EXISTS (SELECT * FROM sys.databases WHERE name='wypozyczalnia_samochodow')
DROP DATABASE wypozyczalnia_samochodow;
GO
--Tworzymy pustą bazę danych
CREATE DATABASE wypozyczalnia_samochodow;
GO
--Wskazujemy bieżącą bazę danych
